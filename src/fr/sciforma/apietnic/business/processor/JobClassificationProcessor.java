...
import fr.sciforma.apietnic.business.model.JobClassificationBo;
...
@Component
public class JobClassificationProcessor extends AbstractSystemDataProcessor<JobClassification, JobClassificationBo> {
    ...
    @Autowired
    private DecimalNoPrecisionExtractor<JobClassification> decimalNoPrecisionExtractor;
    @Autowired
    ...
    @Override
    protected JobClassificationBo buildBusinessObject(List<String> fields) {
        return null;
    }
    ...
    @Override
    public DecimalNoPrecisionExtractor<JobClassification> getDecimalNoPrecisionExtractor() {
