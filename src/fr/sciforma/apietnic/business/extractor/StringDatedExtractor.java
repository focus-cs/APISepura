...
@Component
public class StringDatedExtractor implements Extractor<List<StringDatedData>> {
    ...
    @Override
    public Optional<List<StringDatedData>> extract(FieldAccessor fieldAccessor, String fieldName) {

        return extract(fieldAccessor, fieldName, DatedData.NONE);

    }

    private Optional<List<StringDatedData>> extract(FieldAccessor fieldAccessor, String fieldName, int granularity) {
