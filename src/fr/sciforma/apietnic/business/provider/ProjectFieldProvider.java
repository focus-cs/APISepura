...
public class ProjectFieldProvider implements FieldProvider<Project> {
    ...
    public void init() {
        ...
        fields.add(SciformaField.builder().name("Charge finale").type(FieldType.DECIMAL).build());
        fields.add(SciformaField.builder().name("Charge réelle").type(FieldType.DECIMAL).build());
        fields.add(SciformaField.builder().name("Charge restante").type(FieldType.DECIMAL).build());
        ...
        fields.add(SciformaField.builder().name("Total Labor Effort").type(FieldType.DECIMAL).build());
